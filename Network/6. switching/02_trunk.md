...
만약 Access Mode를 사용하면 하나의 VLAN만 전달할 수 있기 때문에 여러 VLAN을 동시에 전달할 수 없다.
...
하지만 데이터만 보내면 SW1은
이 데이터가 VLAN10인지 VLAN20인지 알 수 없다.
...
Cisco 장비는 Trunk 여부를 자동 협상할 수 있다.
